...
<div class="container m-auto text-center pt-15 pb-5">
    <h1 class="text-6xl font-bold text-gray-900">Add a new Post</h1>
</div>
...
<div class="container m-auto w-4/5 text-center pt-15 pb-5">
    <form action="/blog" method="POST" enctype="multipart/form-data">
        ...
        <textarea name="description" placeholder="Description" class="w-full h-60 text-l rounded-lg shadow-lg border-b p-7 mb-5"></textarea>
